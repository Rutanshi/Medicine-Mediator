...
<div class="sidebar">
  ...
  <a class="nav-link active" href="add_medicine_1.php"><h5>Donate Medicines</h5></a>
  ...
  <div class="card card-primary">
        ...
        <form action="donate.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="form-group">
            ...
            <input type="text" name="medicine_name" class="form-control" id="medicinename" placeholder="Enter Name of Medicine" required>
            <div class="invalid-feedback text-danger">please enter medicine name</div>
          </div>

            <div class="form-group">
            <label for="medicinetype">Medicine Type</label>
            <input type="text" name="medicine_type" class="form-control" id="medicinetype" placeholder="Ex: fever / headache" required>
            <div class="invalid-feedback text-danger">please enter medicine type</div>
          </div>

          <div class="form-group">
            <label for="exampleInputQuantity">Quantity</label>
            <input type="number" name="quantity" class="form-control" id="exampleInputQuantity" autocomplete="off"  min=1  placeholder="Enter No. of Medicine" required>
            <div class="invalid-feedback text-danger">Enter No of medicine</div>
          </div>
          ...
          <div class="form-group">
            <label for="examplefile">Upload Front & Back side of medicine photo</label>
            <input type="file" name="doc[]" class="form-control-file border" id="examplefile" required multiple>
            <div class="invalid-feedback text-danger">Please upload photo here</div>
          </div>
